 ...
 */
public abstract class BaseElectrodeBottomSheetFragment<T extends ElectrodeReactFragmentDelegate> extends BottomSheetDialogFragment implements ElectrodeReactFragmentDelegate.DataProvider {
    private static final String TAG = BaseElectrodeBottomSheetFragment.class.getSimpleName();
    ...
    public BaseElectrodeBottomSheetFragment() {
    }
